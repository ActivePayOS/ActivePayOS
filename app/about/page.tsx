    ...
    <main className="mx-auto max-w-3xl space-y-8">
      <header className="rounded-3xl border bg-white p-6 shadow-sm md:p-8">
        ...
        <p className="mt-3 text-gray-600">
          Hi. We are two lieutenants who started learning about military finances the same way most
          people do: by trying to figure it out ourselves.
        </p>
        <p className="mt-3 text-gray-600">
      ...
      <section className="rounded-2xl border bg-gray-50 p-5 text-xs leading-5 text-gray-500">
        ...
        Defense, DFAS, or VA website, is not affiliated with any branch of the U.S. military, and
        does not provide financial, tax, or legal advice. Figures are estimates — always verify with
        your LES, myPay, and DFAS before making decisions. See the full disclaimer in the page
        footer, our <Link href="/terms" className="underline">Terms</Link>, and{" "}
