...
export const metadata: Metadata = {
  title: "Military Pay Terms Explained",
  description:
    "Plain-English glossary of military pay terms — base pay, BAH, BAS, LES, TSP, and more. For the site's legal terms, see Terms of Service.",
};
