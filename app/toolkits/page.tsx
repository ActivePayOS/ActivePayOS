...
export const metadata: Metadata = {
  title: "Military Money Toolkits",
  description:
    "Life-stage financial toolkits for service members — just commissioned, junior enlisted, just married, first PCS, deployment, TSP, and student loans, plus budget calculators.",
};
  ...
  return (
    <main className="space-y-10">
      <header className="rounded-3xl border bg-white p-8 shadow-sm">
        <h1 className="text-3xl font-semibold tracking-tight">ActivePayOS Toolkits</h1>
