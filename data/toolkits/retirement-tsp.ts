  ...
  sections: [
    ...
    },
    {
      ...
      actions: [
        ...
        { label: "Career Milestone Planner", href: "/toolkits/promotion-timeline", note: "Plan the raise at each step" },
      ],
    },
    {
      type: "actions",
      ...
      actions: [
        ...
        { label: "Blended Retirement System (official site)", href: "https://militarypay.defense.gov/BlendedRetirement/" },
      ],
    },
    {
      type: "text",
